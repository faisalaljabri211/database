...
use sales;
DROP TABLE IF EXISTS inventories, order_items, orders, contacts, customers, products, product_categories,
    employees, warehouses, locations, countries, regions;
...
select sum(quantity)
from order_items; 
-- shows the order date with the sum of it where order_date >= '2017-01-01' and having sum(quantity) > 500;
...
SELECT status, sum(quantity*unit_price) AS 'total_orders'
FROM orders_items ot 
join orders o on (ot.oreder_id = o.order_id)
group by status;
...
select first_name, count (manager_id)
from employees e2
join employee e1
group by first_name;
-- 9. Total Number of Warehouses by Country
SELECT c.country_name, COUNT(w.warehouse_id) AS total_warehouses
FROM warehouses w
...
o.status, oi.item_id, oi.product_id, oi.quantity, oi.unit_price
FROM orders o
INNER JOIN order_items oi ON o.order_id = oi.order_id;


-- use the INNER JOIN with USING clause to retrieve data from orders and order_items
SELECT order_id, order_date, status,item_id, product_id, quantity, unit_price
FROM orders
INNER JOIN order_items USING (order_id);

-- use the INNER JOIN with USING clause to retrieve customer_name, order_id, order_date, item_id, quantity,  unit_price
SELECT c.name AS customer_name, o.order_id, o.order_date, oi.item_id, oi.quantity, oi.unit_price
FROM customers c
...
SELECT c.name AS customer_name, o.order_id, o.order_date,oi.item_id,p.product_name,oi.quantity, oi.unit_price
FROM customers c
INNER JOIN orders o USING (customer_id)
INNER JOIN order_items oi USING (order_id)
...
SELECT o.order_id,c.name AS customer_name,o.status,e.first_name,e.last_name
FROM orders o
LEFT JOIN customers c ON o.customer_id = c.customer_id
LEFT JOIN employees e ON o.salesman_id = e.employee_id;

-- get the order_id, status, employee_id, last_name of order 58.
SELECT o.order_id,o.status,e.employee_id,e.last_name
FROM orders o
LEFT JOIN employees e ON o.salesman_id = e.employee_id
WHERE o.order_id = 58;

-- get the employee_id, last_name, first_name, order_id, status of the salesman id 57 using RIGHT JOIN.
SELECT e.employee_id,e.last_name,e.first_name,o.order_id,o.status
FROM orders o
RIGHT JOIN employees e ON o.salesman_id = e.employee_id
WHERE e.employee_id = 57;

-- Calculate the averages of standard costs and list prices.
SELECT AVG(standard_cost) AS average_standard_cost, AVG(list_price) AS average_list_price
FROM products;

-- calculate the average DISTINCT list prices.
SELECT AVG(DISTINCT list_price) AS avg_distinct_list_price
FROM products;
...
SELECT pc.category_name, AVG(p.list_price) AS avg_list_price
FROM products p
